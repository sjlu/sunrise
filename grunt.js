module.exports = function(grunt) {
	...
	grunt.initConfig({
		...
		shell: {
			...
			deploy: {
	            command: 'git push origin :gh-pages; git branch -D gh-pages; git symbolic-ref HEAD refs/heads/gh-pages; rm -rf .git/index /tmp/public /tmp/node_modules; mv public /tmp; mv node_modules /tmp; git clean -fdx; mv /tmp/public/* .; git add .; git commit -m "auto-generated deployment to gh-pages"; git push origin gh-pages; git checkout master; mv /tmp/node_modules .;',
	            stdout: true
			}
		},
		recess: {
