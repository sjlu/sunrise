		...
		shell: {
			sync: {
	            command: 'rm -rf public/; 
	            	...
	            	cp assets/raw/font-awesome/font/* public/assets/font/; 
	            	cp assets/raw/twitter-bootstrap/img/* public/assets/img/; 
			...
			deploy: {
	            command: 'git stash; 
	            	...
	            	mv /tmp/public/* .; 
	            	git add .; 
	            	git commit -m "auto-generated deployment to gh-pages"; 
	            	git push origin gh-pages; 
	            	git checkout master; 
	            	mv /tmp/node_modules .; 
	            	cp -R /tmp/raw assets/; 
